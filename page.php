...
<section class="single">
  <div style="overflow: hidden;">
    <?if(get_post_meta($post->ID,'abouTimg',1)) { ?>
      <div class="coverTop coverPage" style="background-image: url(<?=get_post_meta($post->ID,'abouTimg',1);?>);">
  ...
  <div class="breadcrumb">
    ...
    <? } elseif(has_post_thumbnail()) { ?>
      <div class="coverTop coverPage" style="background-image: url(<?the_post_thumbnail_url()?>);">
        <div class="Top-title wow fadeInRight"><h1><?the_title()?></h1></div>
  <div class="breadcrumb">
    <ul>
      <li><a class="wow fadeInRight" href="<?=home_url()?>">الرئيسية</a><i class="fas fa-angle-double-left"></i></li>
    ...
    <? } else { ?>
      <div class="coverTop coverPage" style="background-image: url(<?=YC_GetOpt('defultImg')?>);">
        <div class="Top-title wow fadeInRight"><h1><?the_title()?></h1></div>
  <div class="breadcrumb">
    <ul>
      <li><a class="wow fadeInRight" href="<?=home_url()?>">الرئيسية</a><i class="fas fa-angle-double-left"></i></li>
	...
	<div class="container clearfix">
        ...
        <?if(has_post_thumbnail()) { ?>
					<div class="cover wow fadeInUpBig" style="background-image: url(<?the_post_thumbnail_url()?>);"></div>
        <? } else { ?>
          <div class="cover wow fadeInUpBig" style="background-image: url(<?=YC_GetOpt('defultImg')?>);"></div>					
				<? } ?>
        ...
        <? } ?>
				...
				<div class="single-content wow fadeInUpBig"><?the_content()?></div>
