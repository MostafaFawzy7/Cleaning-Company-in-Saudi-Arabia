...
<section class="single">
  <div style="overflow: hidden;">
    <? if(get_post_meta($post->ID,'topCoverOffer',1)) { ?>
      <div class="coverTop" style="background-image: url(<?=get_post_meta($post->ID,'topCoverOffer',1);?>);"></div>
    <? } elseif (has_post_thumbnail()) { ?>
      <div class="coverTop" style="background-image: url(<?the_post_thumbnail_url()?>);"></div>
    <? } else { ?>
      <div class="coverTop" style="background-image: url(<?=YC_GetOpt('defultImg')?>);"></div>
    <? } ?>
  </div>
